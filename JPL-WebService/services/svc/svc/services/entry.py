...
from svc.src.conditionalPdf import call_service
...
def displayRandomForest():
    ...
    try:
      ...
      url = 'http://' + hostname + ':' + port + '/static/randomForest/' + tag + '/' + imgFileName
      print 'url: ', url
...
def displayEOF():
    ...
    try:
      ...
      url = 'http://' + hostname + ':' + port + '/static/EOF/' + tag + '/' + imgFileName
      print 'url: ', url
...
def displayConditionalPdf():
    ...
    try:
      ...
      # instantiate the app. class
      c1 = call_service.call_service(pFile)
      # call the app. function (0 means the image created is scatter plot)
      ### (message, imgFileName) = c1.displayScatterPlot2V(0)
      (message, imgFileName, dataFileName) = c1.display()
      # chdir back
      ...
      url = 'http://' + hostname + ':' + port + '/static/conditionalPdf/' + tag + '/' + imgFileName
      print 'url: ', url
