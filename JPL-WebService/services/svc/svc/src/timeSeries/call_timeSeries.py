...
if __name__ == '__main__':
    c1 = call_timeSeries('ncc_noresm ta 50000 100,140 -20,20 ncc_noresm ta 70000 240,260 -20,20 ncc_noresm ta 60000 160,240 -40,-20 ncc_noresm ts -999999 40,200 20,40 199001 200312', './', '0')
